...
class _IntroPageState extends State<IntroPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(centerTitle: true, title: Image.asset("assets/images/logo.png",height: 30 ,width: 80,),),
      body: BlocBuilder(
        bloc: introBloc,
          ...
          if(state is Start){
            ...
            for(int i = 0 ; i <response.data.length; i++){
              list.add(PageViewModel(
                ...
                decoration: PageDecoration(titleTextStyle: TextStyle(color: Colors.white , fontSize: 20.0 , fontWeight: FontWeight.bold ) ,bodyTextStyle: TextStyle(color: Colors.white , fontSize: 18.0 ) ),
